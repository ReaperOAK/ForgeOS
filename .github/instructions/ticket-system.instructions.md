---
name: Ticket System
description: Use when creating, moving, claiming, or managing tickets, running tickets.py, resolving dependencies, or working with the file-based ticket state machine.
---
