...
tools: [vscode, execute, read, agent, edit, search, web, browser, 'forgeos/*', 'github/*', 'microsoft/markitdown/*', 'playwright/*', vscode.mermaid-chat-features/renderMermaidDiagram, todo]
