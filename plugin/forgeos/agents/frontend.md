...
3. `.forgeos/agents/Frontend.agent.md` — your role, stage, scope, forbidden actions, boot sequence, and **Assigned Tool Loadout**.
...
5. Your upstream summary `.forgeos/agent-output/UIDesigner/Backend/{ticket-id}.md` (if it exists) and the task-relevant skills under `.forgeos/skills/` (see `.forgeos/skills/catalog.yml`).
