...
database live in `.forgeos/prompts/ui-ux-pro-max/PROMPT.md` — read that file and
follow it. It drives Python search scripts under
`.forgeos/prompts/ui-ux-pro-max/scripts/` (`search.py`, `design_system.py`,
`core.py`) over the CSV data in `.forgeos/prompts/ui-ux-pro-max/data/`.
